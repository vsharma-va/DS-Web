...
<div class="w-full h-fit">
    ...
    >
        <div class="flex flex-col w-full pl-[10px] pt-[65px]">
            <p
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        ₹{data.courseData.cost}
                    </p>
                    {#if data.owned}
                        <AllButton btnText="Owned" urlTravelTo=""/>
                    {:else}
                        <AllButton btnText="Buy Course" urlTravelTo="{data.buyLink}"/>
                    {/if}
                </div>
                <div
