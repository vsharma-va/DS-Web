...
<div
        class="fixed top-3 left-[1.5rem] z-[6] cursor-pointer"
...
<div class="fixed top-2 right-[1.5rem] z-[6] cursor-pointer">
...
>
    ...
    <a href="/about-us" class="flex w-full justify-center items-center">
        <div
                class="on-primary-color font-bold primary-font cursor-pointer hover:bg-[#efefef] hover:border-b-4 hover:border-[on-primary-color] px-5 transition-all py-2 rounded-[48px]"
        >
            About Us
